...
// Pantalla de inicio de sesión (login) de la app.
// Nota: Conservamos el nombre de clase LoginScreen para evitar romper
// las rutas existentes. La ubicamos en carpeta en español: pantallas/.
import 'registro_1.dart';
import 'recuperar_contrasena_correo.dart';
import 'menu_principal.dart';
import '../componentes/avisos.dart';
// import '../servicios/api_servicio.dart' show loginUsuario; // Descomentar cuando se integre backend
...
class _LoginScreenState extends State<LoginScreen> {
	...
	Future<void> iniciarSesion() async {
		...
		final pass = contrasenaController.text;
		if (email.isEmpty || pass.isEmpty) {
			showErrorSnackBar(context, 'Por favor completa correo y contraseña');
			return;
		}
		final token = await loginUsuario(email, pass);
		if (token != null) {
			...
			showErrorSnackBar(context, 'Credenciales inválidas');
		}
	}
